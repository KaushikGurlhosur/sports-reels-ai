    ...
    try {
      ...
      const newlyCompleted = data.videos.filter(
        (video: Video) =>
          ...
          previousVideos.some(
            (v) => v.id === video.id && v.status === "processing"
          )
      );
    ...
    <>
      <motion.div
        ...
        <Card className="border-0 shadow-lg rounded-lg overflow-hidden">
          <CardHeader className="flex flex-row items-center justify-between py-4 px-6 bg-gradient-to-r from-blue-500 to-purple-500">
            ...
            <Button
              ...
              size="sm"
              onClick={fetchVideos}
              className="h-8 text-white border-white/30 bg-white/10 hover:bg-white/20">
            ...
            {loading ? (
              ...
              <div className="p-12 text-center space-y-3">
                ...
                <p className="text-gray-500 text-sm">
                  Use the form to create your first video.
                </p>
              </div>
            ) : (
              <div>
